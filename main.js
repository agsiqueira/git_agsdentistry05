const App = {
    ...
    config: {
        AWS_videoURL_Base: "https://agsdentistry05.s3.us-east-1.amazonaws.com/assets/videos/interaction/",
...
async playVideoNow(videoUrl) {
    ...
    async sendMessage() {
        ...
        try {
            const response = await fetch(this.config.ENDPOINT_URL + "agsvh/case5/chat_exact", {
                method: "POST",
